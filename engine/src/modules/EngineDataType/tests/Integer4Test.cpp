...
{
    ntt::Integer4 value("Scores", { 1, 1, 2, 3 }, 0, 100);
...
{
    ntt::Integer4 value("Scores", { 1, 0, 12, 12 });
...
{
    ntt::Integer4 value("Scores", { 11, 0, 11, 2 }, 3, 6);
...
TEST_F(EngineDataTypeTest, Integer4WithStorage)
{
    ...
    storage_->SetGetInteger4Return("Scores", { 4, 3, 8, 2 }, defaultValue);
    storage_->IgnoreSetInteger4("Scores");

    {
        ntt::Integer4 value("Scores", defaultValue, 0, 100, storage_);
...
TEST_F(EngineDataTypeTest, Integer4InitializeViaStorageWithExceedLimits)
{
    ...
    storage_->SetGetInteger4Return("Scores", { 104, 3, 10, 100 }, defaultValue);
    storage_->IgnoreSetInteger4("Scores");
...
{
    ntt::Integer4 value("Scores", { 2, 3, 4, 5 });
...
{
    ntt::Integer4 value("Scores", { 2, 3, 3, 1 }, 0, 10);
...
{
    ntt::Integer4 value("Scores", { 2, 3, 5, 3 }, 0, 10);
...
TEST_F(EngineDataTypeTest, Integer4SavingWhenBeDeleted)
{
    ...
    storage_->SetGetInteger4Return("Scores", { 2, 3, 4, 5 }, defaultValue);

    EXPECT_CALL(*storage_, SaveInteger4("Scores", std::vector<int>{ 1, 1, 1, 1 })).Times(1);
...
{
    ntt::Integer4 value("Scores", { 1, 0, 1, 3 }, 0, 100);
