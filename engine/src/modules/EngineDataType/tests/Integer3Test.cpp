...
{
    ntt::Integer3 value("Scores", { 1, 1, 2 }, 0, 100);
...
{
    ntt::Integer3 value("Scores", { 1, 0, 12 });
...
TEST_F(EngineDataTypeTest, Integer3WithStorage)
{
    ...
    storage_->SetGetInteger3Return("Scores", { 4, 3, 8 }, defaultValue);
    storage_->IgnoreSetInteger3("Scores");

    {
        ntt::Integer3 value("Scores", defaultValue, 0, 100, storage_);
...
TEST_F(EngineDataTypeTest, Integer3InitializeViaStorageWithExceedLimits)
{
    ...
    storage_->SetGetInteger3Return("Scores", { 104, 3, 10 }, defaultValue);
    storage_->IgnoreSetInteger3("Scores");
...
{
    ntt::Integer3 value("Scores", { 2, 3, 4 });
...
{
    ntt::Integer3 value("Scores", { 2, 3, 3 }, 0, 10);
...
{
    ntt::Integer3 value("Scores", { 2, 3, 5 }, 0, 10);
...
TEST_F(EngineDataTypeTest, Integer3SavingWhenBeDeleted)
{
    ...
    storage_->SetGetInteger3Return("Scores", { 2, 3, 4 }, defaultValue);

    EXPECT_CALL(*storage_, SaveInteger3("Scores", std::vector<int>{ 1, 1, 1 })).Times(1);
...
{
    ntt::Integer3 value("Scores", { 1, 0, 1 }, 0, 100);
